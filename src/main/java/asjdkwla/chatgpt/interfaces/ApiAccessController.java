package asjdkwla.chatgpt.interfaces;

import asjdkwla.chatgpt.domain.security.service.JwtUtil;
...
//新增加的API访问准入管理；当访问 OpenAI 接口时，需要进行准入验证。
public class ApiAccessController {
    private Logger logger = LoggerFactory.getLogger(ApiAccessController.class);

    /**
     * http://localhost:8080/authorize?username=hr&password=123
     */
